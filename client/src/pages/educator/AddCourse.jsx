...
const AddCourse = () => {
  ...
  const [discount, setDistcount] = useState(0);
...
// all Tailwind CSS classes are improved only

// NOTE: this is only the styled JSX code from your file:
<div className="p-6 max-w-5xl mx-auto bg-gray-50 min-h-screen">
  <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-2xl shadow-xl border">
    ...
    <button className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 font-semibold transition">
      ADD
    </button>
  </form>
</div>
